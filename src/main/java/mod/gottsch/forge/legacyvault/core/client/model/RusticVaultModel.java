 ...
 */
public class RusticVaultModel extends Model implements IVaultModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(LegacyVault.MOD_ID, "rustic_vault"), "main");
	...
	public RusticVaultModel(ModelPart root) {
