...
public class PersonalVaultScreen extends VaultScreen {
    ...
    protected void renderLabels(PoseStack matrixStack, int mouseX, int mouseY) {
        ...
        this.font.draw(matrixStack, new TranslatableComponent(LangUtil.screen("personal_vault.name")).getString(), LABEL_XPOS, CHEST_LABEL_YPOS, Color.DARK_GRAY.getRGB());
        ...
        if (Config.ServerConfig.PERSONAL.enabled.get()){
            ...
            if (!Config.ServerConfig.PERSONAL.unlimitedVaults.get()) {
                ...
                vaultsRemaining = new TranslatableComponent(LangUtil.screen("vaults_remaining"), String.valueOf(Config.ServerConfig.PERSONAL.vaultsPerPlayer.get() - cap.getCount()), Config.ServerConfig.PERSONAL.vaultsPerPlayer.get()).getString();
            }
            else {
