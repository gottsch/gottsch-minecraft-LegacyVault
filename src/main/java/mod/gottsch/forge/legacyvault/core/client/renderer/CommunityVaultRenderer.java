 ...
 *
 */
public class CommunityVaultRenderer implements BlockEntityRenderer<CommunityVaultBlockEntity> {
	...
	@Override
	public void render(CommunityVaultBlockEntity vaultBlockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource,
