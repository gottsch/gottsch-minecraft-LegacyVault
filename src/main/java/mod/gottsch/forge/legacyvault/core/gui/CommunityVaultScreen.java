...
public class CommunityVaultScreen extends VaultScreen {
    ...
    protected void renderLabels(PoseStack matrixStack, int mouseX, int mouseY) {
        ...
        this.font.draw(matrixStack, new TranslatableComponent(LangUtil.screen("community_vault.name")).getString(), LABEL_XPOS, getMenu().getVaultsRemainingYPos(),Color.darkGray.getRGB());
    }
}
