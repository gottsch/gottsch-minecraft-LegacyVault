...
public class CommunityVaultScreen extends VaultScreen {
    ...
    protected void renderLabels(GuiGraphics gui, int mouseX, int mouseY) {
        ...
        gui.drawString(this.font, Component.translatable(LangUtil.screen("community_vault.name")).getString(), LABEL_XPOS, CHEST_LABEL_YPOS, Color.DARK_GRAY.getRGB(), false);
    }
}
