...
public class ItemTagsProvider extends net.minecraft.data.tags.ItemTagsProvider {
	public ItemTagsProvider(DataGenerator output,
							BlockTagsProvider blockTagProvider, @Nullable ExistingFileHelper existingFileHelper) {
		super(output, blockTagProvider, LegacyVault.MOD_ID, existingFileHelper);
	}
