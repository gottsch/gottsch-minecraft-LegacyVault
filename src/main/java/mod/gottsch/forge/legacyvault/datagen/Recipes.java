...
public class Recipes extends RecipeProvider implements IConditionBuilder {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> recipe) {
		...
		// contract
		ShapedRecipeBuilder.shaped(ModItems.CONTRACT.get())
				.pattern("pip")
				.pattern("pip")
				.pattern("pip")
		...
		ConditionalRecipe.builder()
				...
				.addRecipe(rustic -> {
					ShapedRecipeBuilder.shaped(ModBlocks.RUSTIC_VAULT.get())
							.pattern(	"iiv")
							.pattern("ici")
							.pattern("iii")
		...
		ConditionalRecipe.builder()
				...
				.addCondition(VaultNormalDifficultyCondition.INSTANCE)
				.addRecipe(classic -> {
					ShapedRecipeBuilder.shaped(ModBlocks.CLASSIC_VAULT.get())
							.pattern("iiv")
							.pattern("ici")
							.pattern("iii")
							.define('i', Items.IRON_INGOT)
