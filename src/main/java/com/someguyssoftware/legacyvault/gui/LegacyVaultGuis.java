...
public class LegacyVaultGuis {
	...
	public static class RegistrationHandler {
		...
		public static void onClientSetupEvent(FMLClientSetupEvent event) {
			...
			ScreenManager.register(LegacyVaultContainers.MEDIUM_VAULT_CONTAINER_TYPE, MediumVaultContainerScreen::new);
			ScreenManager.register(LegacyVaultContainers.LARGE_VAULT_CONTAINER_TYPE, LargeVaultContainerScreen::new);
//			ScreenManager.register(LegacyVaultContainers.STANDARD_VAULT_CONTAINER_TYPE, ScrollableVaultContainerScreen3::new);
...
//			ClientRegistry.bindTileEntityRenderer(LegacyVaultTileEntities.VAULT_TILE_ENTITY_TYPE, VaultTileEntityRenderer::new);
			ClientRegistry.bindTileEntityRenderer(LegacyVaultTileEntities.VAULT_TILE_ENTITY_TYPE, VaultTileEntityRenderer<VaultTileEntity>::new);
			ClientRegistry.bindTileEntityRenderer(LegacyVaultTileEntities.MEDIUM_VAULT_TILE_ENTITY_TYPE, VaultTileEntityRenderer<MediumVaultTileEntity>::new);
			ClientRegistry.bindTileEntityRenderer(LegacyVaultTileEntities.LARGE_VAULT_TILE_ENTITY_TYPE, VaultTileEntityRenderer<LargeVaultTileEntity>::new);
