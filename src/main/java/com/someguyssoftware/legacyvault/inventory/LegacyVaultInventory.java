 ...
 *
 */
public class LegacyVaultInventory implements IInventory {
	    ...
	    * @param size
	    */
	   public LegacyVaultInventory(int size) {
	      this.size = size;
